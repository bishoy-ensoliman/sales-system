<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GarasERP.Master" AutoEventWireup="true" CodeBehind="ViewReport.aspx.cs" Inherits="GarasSales.Sales.Reports.ViewReport" %>
                  ...
                  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    FilteredDataSourcePropertyName="FilterExpression" FilteredDataSourcePropertyFormat="{1} = '{0}'" EnableViewState="true" 
                     ...
                     <div class=" mt-3">
                         ...
                         <asp:Label ID="LBL_Review" runat="server" Text="Label"></asp:Label>
                        </div>
				    <div class=" mt-3">
                            ...
                            <asp:TextBox ID="TXT_Desc" ReadOnly="true" runat="server" TextMode="multiline" Columns="50" Rows="5" PlaceHolder="Write Your Text Here" class="textArea p-3 w-100"></asp:TextBox>
                            
                        </div>
                              <div class="row my-4">
				             <div class="col-md-4 offset-md-8 text-right">
                   
                                 <asp:Button CssClass="btn text-white save px-5 py-1 robotoBold primaryColorBlue" ID="BTN_Save" runat="server" Text="Close" OnClick="BTN_Save_Click" />
